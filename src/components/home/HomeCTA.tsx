...
export default function HomeCTA() {
  return (
    <section className="py-10 bg-gradient-to-b from-stone-50 to-emerald-50/50">
      <div className="max-w-4xl mx-auto px-6 text-center">
        ...
        <Link 
          to="/contact" 
          className="inline-flex items-center gap-3 px-8 py-4 bg-emerald-600 text-white rounded-full font-bold text-lg hover:bg-emerald-700 hover:shadow-lg transition-all duration-300 mb-5"
        >
        ...
        {/* CONTACT INFO */}
        <div className="grid md:grid-cols-3 gap-5 pt-12 border-t border-stone-200/60 text-slate-600">
