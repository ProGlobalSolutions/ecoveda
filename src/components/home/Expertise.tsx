...
export default function Expertise() {
  ...
  const expertise = [
    ...
    },
    {
      ...
      icon: Orbit,
      description:
        'Biochar Carbon Sequestration • Enhanced Rock Weathering • Direct Air Capture •  Open Ex-situ Mineralisation',
    ...
    },
    {
      ...
      icon: Wind,
      description:
        'Solar • Wind • Hydropower • Biogas • Clean Cooking Solutions • Safe Drinking Water  • Efficient Lighting • Fuel Switching',
    ...
    },
    {
      ...
      icon: Factory,
      description:
        'Waste Heat Recovery • E-Waste Recycling • Landfill Gas • End-of-Life Vehicle Recovery • Biodiesel Production • Industrial Efficiency',
...
>
  {renderLetters('Our Expertise')}
          ...
          <h2 className="mt-6 text-4xl font-black leading-tight text-slate-900 md:text-6xl">
            {renderLetters('Where We Operate Across the Carbon Landscape')}
          </h2>
