...
export default function BlogDetail() {
  ...
  if (!blog) {
    return (
      <div className="pt-20 pb-16 text-center text-2xl font-bold text-slate-800">
        Blog Not Found
      </div>
    );
  }
  ...
  return (
    <div className="pt-16">
      ...
      {/* HERO */}
      <section className="py-10 bg-emerald-600 text-white text-center mt-10 md:mt-0 relative overflow-hidden">
        <div className="relative z-10 max-w-4xl mx-auto px-6">
          <Link
            to="/blogs"
            className="text-sm mb-5 inline-block font-semibold text-emerald-100 hover:text-white transition"
          >
            ← Back to Blogs
          </Link>
      ...
      {/* CONTENT */}
      <section className="py-16 md:py-10 bg-stone-50">
        <div className="max-w-4xl mx-auto px-6">
          
          {/* BLOG IMAGE */}
          <div className="w-full h-[300px] sm:h-[400px] md:h-[500px] rounded-3xl overflow-hidden shadow-xl shadow-slate-200/50 mb-6">
            <img
              src={blog.image}
              alt={blog.title}
          ...
          <div className="mb-6 border-b border-slate-100 pb-8 text-center md:text-left">
